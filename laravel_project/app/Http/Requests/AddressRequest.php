...
class AddressRequest extends FormRequest
{
	...
	public function rules()
	{
        return [
			...
			'phone' => 'required|regex:/^[0-9]*$/|digits_between:8,11',
        ];
	}
